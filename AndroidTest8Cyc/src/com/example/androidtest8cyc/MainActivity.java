	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		expandableListView.setOnGroupClickListener(new OnGroupClickListener() {
			...
			public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
				...
				Toast.makeText(MainActivity.this, "您点击了"+aGroups.get(groupPosition).getName()+"分组", Toast.LENGTH_SHORT).show();
				return false;
			}
		});
		...
		expandableListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
				// TODO Auto-generated method stub
				Toast.makeText(MainActivity.this, "进入和"+aGroups.get(groupPosition).getaChilds().get(childPosition).getName()+"的聊天界面", Toast.LENGTH_SHORT).show();
				return false;
			}
		});
		...
		expandableListView.setOnGroupCollapseListener(new OnGroupCollapseListener() {
			...
			public void onGroupCollapse(int groupPosition) {
				// TODO Auto-generated method stub
				Toast.makeText(MainActivity.this, "您折叠了"+aGroups.get(groupPosition).getName()+"分组", Toast.LENGTH_SHORT).show();
		...
		expandableListView.setOnGroupExpandListener(new OnGroupExpandListener() {
			...
			public void onGroupExpand(int groupPosition) {
				// TODO Auto-generated method stub
				Toast.makeText(MainActivity.this, "您展开了"+aGroups.get(groupPosition).getName()+"分组", Toast.LENGTH_SHORT).show();
